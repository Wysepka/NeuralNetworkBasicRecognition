...
void RenderingSystem::DisposeRendering()
{
	// Cleanup
...
void RenderingSystem::ProcessMainRenderingLoop(bool& shouldBeRendering, int& retFlag)
{
	shouldBeRendering = glfwWindowShouldClose(window) == 0 ? true : false;
